...
window.injectNavbar = function(container) {
    ...
    // Check if the current page is in the customer subdirectory
    const isInCustomer = currentPath.includes('/customer/');
    ...
    const personIcon = auth
        ? `<div class="relative group">
                ...
                <div class="absolute right-0 top-full mt-2 w-48 bg-paper-white border border-outline-variant/30 shadow-md py-2 invisible group-hover:visible opacity-0 group-hover:opacity-100 transition-all z-50">
                    <a href="${customerPrefix}homepage.html" class="block px-4 py-2 text-xs font-label-caps text-on-surface hover:bg-surface-container transition-colors">Dashboard</a>
    ...
    <header class="sticky top-0 w-full z-50 bg-surface/95 dark:bg-surface-container/95 backdrop-blur-md border-b border-outline/10 dark:border-outline/20">
        <div class="flex justify-between items-center w-full px-6 md:px-margin-desktop py-6 max-w-container-max mx-auto">
            ...
            <a href="${homeLink}" class="font-headline-md text-headline-md tracking-tight text-deep-espresso dark:text-primary-fixed select-none hover:opacity-85 transition-opacity" aria-label="Sela Cafe Home">
                Sela Cafe
            </a>
            ...
            <div class="flex items-center gap-6 text-deep-espresso">
                <a href="${webPrefix}menu.html" class="hover:opacity-80 transition-all duration-300 active:scale-95" aria-label="Search menu">
    ...
    <footer class="bg-deep-espresso dark:bg-surface-container-lowest border-t border-outline/20 w-full">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-gutter px-6 md:px-margin-desktop py-20 max-w-container-max mx-auto">
            ...
            <div>
                ...
                <ul class="space-y-4">
                    <li><a class="text-on-primary-container dark:text-on-surface-variant font-label-caps tracking-widest hover:text-tertiary-fixed transition-colors" href="${webPrefix}home.html">Our Story</a></li>
                    <li><a class="text-on-primary-container dark:text-on-surface-variant font-label-caps tracking-widest hover:text-tertiary-fixed transition-colors" href="${webPrefix}locations.html">Locations</a></li>
            ...
            <div>
                ...
                <ul class="space-y-4">
                    ...
                    <li><a class="text-on-primary-container dark:text-on-surface-variant font-label-caps tracking-widest hover:text-tertiary-fixed transition-colors" href="${webPrefix}career.html">Career</a></li>
